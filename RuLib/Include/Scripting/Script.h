...
#define CMD_STR_END "]"
#define CMD_STOP "STOP" //Stops the script
#define CMD_WAIT "WAIT"
#define CMD_GET_ASSET "ASSET" //Get asset from Name from name  ASSET Name
//#define CMD_ADD_COMP "ADDCOMP" //Adds components to object
//#define CMD_GET_COMP "GETCOMP"  //Gets component from context obj

//Components
#define COMP_ADD "ADDCOMP"
